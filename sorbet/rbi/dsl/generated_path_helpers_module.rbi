...
module GeneratedPathHelpersModule
  ...
  def edit_project_subproject_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def fizz_buzz_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def new_project_subproject_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def project_subproject_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def project_subprojects_path(*args); end
