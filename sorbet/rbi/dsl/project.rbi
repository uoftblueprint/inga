...
class Project
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Project` class because it declared `has_many :reports`.
    ...
    # This method is created by ActiveRecord on the `Project` class because it declared `has_many :subprojects`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
