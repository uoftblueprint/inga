...
class Report
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Report` class because it declared `has_many :snapshots`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Snapshot::PrivateCollectionProxy) }
    def snapshots; end

    sig { params(value: T::Enumerable[::Snapshot]).void }
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def expiry_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def expiry_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_expiry?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_expiry?(from: T.unsafe(nil), to: T.unsafe(nil)); end
